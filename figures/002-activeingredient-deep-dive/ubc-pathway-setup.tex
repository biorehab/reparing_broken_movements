...
\begin{tikzpicture}[x=1cm, y=1cm]
  ...
  \node[nodeA, label={[font=\scriptsize]below:$x_2$}]  (x2)  at (0.0,  2.0)  {};
  \node[nodeA, label={[font=\scriptsize]below:$x_3$}]  (x3)  at (0.0, -2.0)  {};
  \node[nodeA, label={[font=\scriptsize]above:$x_5$}]  (x5)  at (2.0,  1.0)  {};
  \node[nodeAB, label={[font=\scriptsize]above left:$x_6$}]  (x6)  at (4.0,  2.0)  {};
  \node[nodeAB, label={[font=\scriptsize]left:$x_7$}]  (x7)  at (5.0,  1.0)  {};
  \node[nodeA, label={[font=\scriptsize]above:$x_8$}]  (x8)  at (3.0,  0.0)  {};
  \node[ubc1]                                          (x9)  at (2.0, -2.0)  {};
  \node[nodeB, label={[font=\scriptsize]above:$x_{10}$}] (x10) at (3.0, -2.5) {};
  \node[nodeB, label={[font=\scriptsize]above:$x_{11}$}] (x11) at (5.0, -1.0) {};
  ...
  %%
  \node[nodeA, label={[color=treatA, font=\scriptsize\bfseries]left:$A_1$}] (nA1) at (0, 3.2) {};
  % \node[nodeA, label={[color=treatA, font=\scriptsize\bfseries]left:$A_2$}] (nA2) at (0, 1.3) {};
  \node[nodeA, label={[color=treatA, font=\scriptsize\bfseries]left:$A_2$}] (nA2) at (0, -0.8) {};
  \node[nodeB, label={[color=treatB, font=\scriptsize\bfseries]left:$B_1$}] (nB1) at (4.0, 3.5) {};
  \node[nodeB, label={[color=treatB, font=\scriptsize\bfseries]left:$B_2$}] (nB2) at (3.0, -4.0) {};
  ...
  % \draw[treatA edge]   (x1) -- (x5);
  % \draw[treatA edge]   (x1) -- (x8);
  ...
  % \draw[treatA edge] (nA2) -- (x1);
  \draw[treatA edge] (nA2) -- (x3);
  \draw[treatB edge] (nB1) -- (x6);
  \draw[treatB edge] (nB2) -- (x10);
  
  %%
  %% \draw[ingrB] (3.0, 6.2) -- (nB1)
  %%   node[pos=0, above, color=treatB, font=\scriptsize\bfseries] {$B_1$};
