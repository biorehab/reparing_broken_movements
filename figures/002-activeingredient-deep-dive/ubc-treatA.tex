...
\begin{tikzpicture}[x=1cm, y=1cm]
  ...
  %%
  %% UBC 1
  \node[ubc1, label={below:$x_1$}]            (x1)  at (0.0,  0.0)  {};
  \node[nodeA, label={below:$x_2$}]           (x2)  at (0.0,  2.0)  {};
  \node[nodeA, label={below left:$x_3$}]           (x3)  at (0.0, -2.0)  {};
  ...
  %%
  \node[font=\small\bfseries, color=treatA] (nA1) at (0, 3.2)  {$A_1$};
  \node[font=\small\bfseries, color=treatA] (nA2) at (0, -0.8) {$A_2$};
